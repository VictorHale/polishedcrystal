MountMortar2FInside_MapScriptHeader:
	...
	tmhmball_event 19, 17, TM_FARORES_WIND, EVENT_MOUNT_MORTAR_2F_INSIDE_TM_FARORES_WIND
	...
	itemball_event 28,  5, MOGMA_MITTS, 1, EVENT_MOUNT_MORTAR_2F_INSIDE_MOGMA_MITTS
