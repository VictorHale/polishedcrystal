...
endc
	...
	db 75, PINSIR, HAWKEYE, ABILITY_1 | NAT_NEUTRAL, MALE
		db MEGAHORN, SWORDS_DANCE, CLOSE_COMBAT, EARTHQUAKE
	db 75, SCYTHER, SHIELD, ABILITY_1 | NAT_NEUTRAL, FEMALE
...
; ================
	...
	db 19, CLEFAIRY, NO_ITEM, 48, ABILITY_1 | NAT_NEUTRAL, FEMALE
		db METRONOME, DISARM_VOICE, SKY_UPPERCUT, ATTRACT
...
if DEF(FAITHFUL)
	db 26, GENGAR, TRUTH_LENS, 64, ABIL_GENGAR_CURSED_BODY | NAT_NEUTRAL, MALE
else
	db 26, GENGAR, TRUTH_LENS, 64, ABIL_GENGAR_LEVITATE | NAT_NEUTRAL, MALE
endc
...
if DEF(FAITHFUL)
	db 74, HAUNTER, SHIELD, ABIL_HAUNTER_LEVITATE | NAT_NEUTRAL, MALE
...
; ================
	...
	db 33, SCIZOR, NO_ITEM, 96
		db PURSUIT, AERIAL_ACE, GILDED_SLASH, SLASH
...
; ================
	...
	db 39, DEWGONG, CHESTO_BERRY, 112
		db WATERFALL, REST, RAIN_DANCE, JABUS_FROST
	...
	db 42, MAMOSWINE, SITRUS_BERRY, 112
		db ELDINS_WRATH, ANCIENTPOWER, AVALANCHE, FURY_STRIKES
	db -1 ; end
...
if DEF(FAITHFUL)
	...
	db 73, AMPHAROS, DRAGON_FANG, ABILITY_1 | NAT_NEUTRAL, FEMALE
		db THUNDER_WAVE, CONFUSE_RAY, THUNDERBOLT, DRAGON_PULSE
endc
	db 74, DRAGONAIR, SHIELD, ABILITY_1 | NAT_NEUTRAL, FEMALE
...
; ================
	...
	db 70, MUK, BRIGHTPOWDER, ABILITY_1 | NAT_NEUTRAL, MALE
		db MINIMIZE, SOLAR_FLARE, GUNK_SHOT, TOXIC
...
; ================
	...
	db 76, HOUNDOOM, WISE_GLASSES
		db ROAR, NASTY_PLOT, SOLAR_FLARE, DARK_PULSE
	db -1 ; end
...
; ================
	...
	db 58, DRAGONITE, TRUTH_LENS, 208, ABIL_DRAGONITE_INNER_FOCUS | NAT_SATK_UP_ATK_DOWN, MALE
		db SOLAR_FLARE, BLIZZARD, THUNDER, HYPER_BEAM
	db 58, KINGDRA, HAWKEYE, 208, ABIL_KINGDRA_SNIPER | NAT_SATK_UP_ATK_DOWN, MALE
	...
	db 57, CHARIZARD, WISE_GLASSES, 208, ABIL_CHARIZARD_DROUGHT | NAT_SATK_UP_ATK_DOWN, MALE
if DEF(FAITHFUL)
...
if DEF(FAITHFUL)
	db 75, CHARIZARD, LIFE_ORB, ABIL_CHARIZARD_DROUGHT | NAT_SATK_UP_ATK_DOWN, MALE
		db SOLAR_FLARE, SOLAR_BEAM, FOCUS_BLAST, AIR_SLASH
else
...
; ================
	...
	db 74, OCTILLERY, CHARCOAL
		db SOLAR_FLARE, ICE_BEAM, HYDRO_PUMP, POWER_WHIP
...
if DEF(FAITHFUL)
		...
		db SUNNY_DAY, LEECH_SEED, GIGA_DRAIN, SOLAR_FLARE
endc
...
; ================
	...
	db 63, WEEZING, NO_ITEM, 208
		db SLUDGE_BOMB, THUNDER, SOLAR_FLARE, EXPLOSION
	db 66, VENOMOTH, SITRUS_BERRY, 208
		db SLUDGE_BOMB, DOUBLE_TEAM, AERIAL_ACE, PSYCHIC_M
	db -1 ; end
...
; ================
	...
	db 73, WEEZING, CHARCOAL
		db SLUDGE_BOMB, SOLAR_FLARE, WILL_O_WISP, EXPLOSION
...
; ================
	...
	db 65, FLAREON, NO_ITEM, 240
		db WILL_O_WISP, FLARE_BLITZ, QUICK_ATTACK, SOLAR_FLARE
	db 69, RAPIDASH, SITRUS_BERRY, 240
		db QUICK_ATTACK, FIRE_SPIN, PLAY_ROUGH, SOLAR_FLARE
	db -1 ; end
	...
	db 72, MAGMORTAR, BLACK_BELT
		db SUNNY_DAY, FOCUS_BLAST, SOLAR_FLARE, FLASH_CANNON
	...
	db 72, TYPHLOSION, LEFTOVERS
		db SOLAR_FLARE, FOCUS_BLAST, EARTH_POWER, HIDDEN_POWER
...
if DEF(FAITHFUL)
	...
	db 100, VENUSAUR, MIRACLE_SEED, FAKE_PERFECT_DVS, ABIL_VENUSAUR_SOLAR_POWER | NAT_SPD_UP_DEF_DOWN, FEMALE
endc
	...
	db 98, MOLTRES, CHARCOAL, DVS_HP_GRASS, ABIL_MOLTRES_FLAME_BODY | NAT_SATK_UP_ATK_DOWN, FEMALE
		db SOLAR_FLARE, AIR_SLASH, HIDDEN_POWER, PSYCHO_CUT
...
; ================
	...
	db 70, ALAKAZAM, BRIGHTPOWDER
		db RECOVER, TRI_ATTACK, PSYCHIC_M, REFLECT
	db 72, CLEFABLE, LEFTOVERS
		db SOLAR_FLARE, FOCUS_BLAST, EARTH_POWER, SMOKESCREEN
	db -1 ; end
...
; ================
	...
	db 18, PIKACHU, LIGHT_BALL, 36, "Chicory@"
	db -1 ; end
...
; ================
	...
	db 15, MAREEP, NO_ITEM, 36, "@"
	db 18, CLEFAIRY, LIGHT_CLAY, 36, "Clefame@"
	db -1 ; end
...
; ================
	...
	db 15, MAREEP, NO_ITEM, 36, "@"
	db 18, EEVEE, SITRUS_BERRY, 36, "Eon@"
	db -1 ; end
...
; ================
	...
	db 37, PIKACHU, LIGHT_BALL, 100, "Paichu@"
	db -1 ; end
...
; ================
	...
	db 34, AZUMARILL, NO_ITEM, 100, "@"
	db 32, FLAAFFY, NO_ITEM, 100, "@"
	db 37, CLEFAIRY, LIGHT_CLAY, 100, "Clefame@"
	db -1 ; end
...
; ================
	...
	db 34, GROWLITHE, NO_ITEM, 100, "@"
	db 32, FLAAFFY, NO_ITEM, 100, "@"
	db 37, EEVEE, SITRUS_BERRY, 100, "Eon@"
	db -1 ; end
...
; ================
	...
	db 47, PIKACHU, LIGHT_BALL, 132, "Paichu@"
	db -1 ; end
...
; ================
	...
	db 45, AZUMARILL, NO_ITEM, 132, "@"
	db 46, AMPHAROS, NO_ITEM, 132, "@"
	db 47, CLEFAIRY, LIGHT_CLAY, 132, "Clefame@"
	db -1 ; end
...
; ================
	...
	db 45, ARCANINE, NO_ITEM, 132, "@"
	db 46, AMPHAROS, NO_ITEM, 132, "@"
	db 47, EEVEE, SITRUS_BERRY, 132, "Eon@"
	db -1 ; end
...
; ================
	...
	db 72, RAICHU, LIGHT_BALL, "Paichu@"
	db -1 ; end
...
; ================
	...
	db 71, AMPHAROS, NO_ITEM, "@"
	db 68, GIRAFARIG, NO_ITEM, "@"
	db 72, CLEFABLE, LIGHT_CLAY, "Clefame@"
	db -1 ; end
...
; ================
	...
	; party
	db 30, BUTTERFREE
		db CONFUSION, POISONPOWDER, SUPERSONIC, AERIAL_ACE
	db 30, BUTTERFREE
		db CONFUSION, STUN_SPORE, SUPERSONIC, AERIAL_ACE
	db 32, BEEDRILL
		db FURY_STRIKES, PURSUIT, U_TURN, DOUBLE_TEAM
	db 34, BUTTERFREE
		db PSYBEAM, SLEEP_POWDER, AERIAL_ACE, HEALINGLIGHT
	db -1 ; end
...
; ================
	...
	; party
	db 36, VENOMOTH
		db AERIAL_ACE, SUPERSONIC, PSYBEAM, LEECH_LIFE
	db -1 ; end
...
; ================
	...
	; party
	db 40, VENOMOTH
		db AERIAL_ACE, SUPERSONIC, PSYCHIC_M, TOXIC
	db -1 ; end
...
; ================
	...
	db 34, GRAVELER
		db DEFENSE_CURL, ROLLOUT, ELDINS_WRATH, ROCK_SLIDE
	db 36, MAGCARGO
...
; ================
	...
	; party
	db 16, MARILL
		db DEFENSE_CURL, ROLLOUT, BUBBLE_BEAM, PLASTIZE
	db 16, MAREEP
...
; ================
	...
	db 42, OCTILLERY
		db PSYBEAM, JABUS_FROST, OCTAZOOKA, HYPER_BEAM
	db -1 ; end
...
; ================
	...
	; party
	db 36, REMORAID
		db FLAMETHROWER, PSYBEAM, JABUS_FROST, BUBBLE_BEAM
	db 36, REMORAID
		db ICE_BEAM, PSYBEAM, JABUS_FROST, BUBBLE_BEAM
	db -1 ; end
...
; ================
	...
	; party
	db 24, PIDGEOTTO
		db AERIAL_ACE, QUICK_ATTACK, RAGE, MUD_SLAP
	db 24, PIDGEOTTO
		db AERIAL_ACE, QUICK_ATTACK, RAGE, DOUBLE_TEAM
	db 27, GOLDUCK
...
; ================
	...
	; party
	db 34, GRAVELER
		db ELDINS_WRATH, MUD_SLAP, SANDSTORM, ROCK_SLIDE
	db 36, GOLEM
...
; ================
	...
	db 36, DUGTRIO
		db ELDINS_WRATH, DIG, MUD_SLAP, SLASH
	db 39, STEELIX
...
; ================
	...
	; party
	db 60, EEVEE, SHIELD, ABILITY_1 | NAT_SPD_UP_DEF_DOWN, FEMALE, "VuiVui@"
...
; ================
	...
	; party
	db 60, MARILL, SHIELD, ABIL_MARILL_HUGE_POWER | NAT_NEUTRAL, FEMALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY
	; party
	db 14, MAGBY, SHIELD, ABILITY_1 | NAT_NEUTRAL, FEMALE
	db 14, ELEKID, SHIELD, SHINY_MASK | ABILITY_1 | NAT_NEUTRAL, FEMALE
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_MOVES
	; party
	db 27, TYROGUE, SHIELD
		db TACKLE, RAGE, FORESIGHT, HI_JUMP_KICK
	db 28, MUNCHLAX, SHIELD
...
; ================
	...
	db 43, CHARIZARD, FOCUS_SASH, 132, ABIL_CHARIZARD_SOLAR_POWER | NAT_ATK_UP_SATK_DOWN, MALE
...
; ================
	...
	db 55, SMEARGLE, CHARCOAL, DVS_HP_FIRE ; red
		db SOLAR_FLARE, FLAMETHROWER, EARTH_POWER, WILL_O_WISP
...
; ================
	...
	; party
	db 36, CHARMELEON
		db SMOKESCREEN, GILDED_SLASH, DRAGON_RAGE, FLAME_CHARGE
	db 35, MAGNETON
...
; ================
	...
	db 11, ZUBAT, MIRACLE_SEED, 20, $EE, $EE, $EE, ABIL_ZUBAT_INNER_FOCUS | NAT_SATK_UP_SDEF_DOWN, MALE
		db AERIAL_ACE, ABSORB, ASTONISH, BITE
...
; ================
	...
	db 49, RAPIDASH, FOCUS_BAND
		db STOMP, FIRE_SPIN, PLAY_ROUGH, SOLAR_FLARE
...
; ================
	...
	db 21, CHARMELEON, BINDING_BAND, 52, ABIL_CHARMELEON_DROUGHT | NAT_SPD_UP_DEF_DOWN, FEMALE
...
; ================
	...
	db 41, FERALIGATR, KINGS_ROCK
		db SCARY_FACE, GILDED_SLASH, CRUNCH, WATERFALL
...
endc
	db 41, NINETALES, CHARCOAL
		db FLAMETHROWER, SHADOW_BALL, CONFUSE_RAY, PSYCHO_CUT
...
if DEF(FAITHFUL)
	...
	db 37, UMBREON, ROCKY_HELMET, 116, ABIL_UMBREON_SERENE_GRACE | NAT_NEUTRAL, MALE
endc
...
; ================
	...
	db 41, WEEZING, CHARCOAL
		db SOLAR_FLARE, EXPLOSION, SLUDGE_BOMB, SMOKESCREEN
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 39, KOFFING, SHIELD, ABILITY_1 | NAT_NEUTRAL, MALE
		db TACKLE, EXPLOSION, VENOSHOCK, SMOKESCREEN
	db 39, GOLBAT, SHIELD, ABILITY_1 | NAT_NEUTRAL, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 34, GOLBAT, SHIELD, 108, ABILITY_1 | NAT_NEUTRAL, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 41, HOUNDOUR, SHIELD, ABILITY_1 | NAT_NEUTRAL, MALE
...
endc
if !DEF(FAITHFUL)
	db 62, RHYDON, SHIELD, ABIL_RHYDON_SOLID_ROCK | NAT_ATK_UP_SATK_DOWN, MALE
else
	db 62, RHYDON, SHIELD, ABIL_RHYDON_LIGHTNING_ROD | NAT_ATK_UP_SATK_DOWN, MALE
endc
...
if DEF(FAITHFUL)
	...
	db 80, VENUSAUR, BIG_ROOT, ABIL_VENUSAUR_SOLAR_POWER | NAT_SDEF_UP_ATK_DOWN, FEMALE
endc
		db SUNNY_DAY, SOLAR_BEAM, VENOSHOCK, TOXIC
...
endc
	...
	db 80, BLASTOISE, WHITE_HERB, ABIL_BLASTOISE_RAIN_DISH | NAT_SDEF_UP_SATK_DOWN, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 27, DROWZEE, SHIELD, FAKE_PERFECT_DVS, ABIL_DROWZEE_INSOMNIA | NAT_NEUTRAL, MALE
...
; ================
	...
	db 75, DRAGONITE, WISE_GLASSES
		db HURRICANE, DRAGON_PULSE, SOLAR_FLARE, BLIZZARD
...
; ================
	...
	db 41, DEWGONG, NO_ITEM, 120
		db WATERFALL, JABUS_FROST, SLEEP_TALK, REST
	db 40, CLOYSTER, NO_ITEM, 120
		db DEFENSE_CURL, ROLLOUT, JABUS_FROST, EXPLOSION
...
; ================
	...
	db 61, MISDREAVUS, SHIELD, 180, ABILITY_1 | NAT_NEUTRAL, FEMALE
...
endc
	...
	db 65, SNORLAX, LEFTOVERS, FAKE_PERFECT_DVS, NAT_ATK_UP_SATK_DOWN | ABIL_SNORLAX_IMMUNITY, MALE
		db CURSE, REST, SLEEP_TALK, RETURN
if DEF(FAITHFUL)
	db 65, JYNX, TRUTH_LENS, FAKE_PERFECT_DVS, NAT_SATK_UP_ATK_DOWN | ABIL_JYNX_OBLIVIOUS, FEMALE
else
	db 65, JYNX, TRUTH_LENS, FAKE_PERFECT_DVS, NAT_SATK_UP_ATK_DOWN | ABIL_JYNX_FILTER, FEMALE
endc
...
; ================
	...
	db 36, AZUMARILL, NO_ITEM, 112
		db PLAY_ROUGH, AQUA_TAIL, PLASTIZE, ROLLOUT
...
; ================
	...
	db 56, AZUMARILL, MUSCLE_BAND, 160, ABILITY_1 | NAT_NEUTRAL, FEMALE
		db PLAY_ROUGH, WATERFALL, PLASTIZE, CLOSE_COMBAT
...
; ================
	...
	db 72, RAPIDASH, KINGS_ROCK, ABILITY_1 | NAT_NEUTRAL, FEMALE | GALARIAN_FORM
		db SOLAR_FLARE, ZEN_HEADBUTT, PLAY_ROUGH, WILD_CHARGE
...
; ================
	...
	db 41, GRAVELER, SHIELD, 120, ABIL_GRAVELER_STURDY | NAT_ATK_UP_SATK_DOWN, FEMALE, "Gravvy@"
	...
	db 40, OMANYTE, SITRUS_BERRY, 120, ABIL_OMANYTE_SHELL_ARMOR | NAT_NEUTRAL, FEMALE, "Omny@"
		db SURF, PROTECT, ANCIENTPOWER, JABUS_FROST
...
; ================
	...
	db 29, NOCTOWL, NO_ITEM, 92
		db FARORES_WIND, NIGHT_SHADE, REFLECT, PSYCHO_CUT
	...
	db 32, SKARMORY, SITRUS_BERRY, 92
		db GILDED_SLASH, FURY_STRIKES, DRILL_PECK, SWIFT
	db -1 ; end
...
if DEF(FAITHFUL)
		db SWORDS_DANCE, SOLAR_FLARE, ROCK_SLIDE, AERIAL_ACE
else
		db SWORDS_DANCE, SOLAR_FLARE, ROCK_SLIDE, DRAGON_CLAW
endc
...
; ================
	...
	db 58, RAPIDASH, KINGS_ROCK, 160
		db SOLAR_FLARE, MEGAHORN, POISON_JAB, WILL_O_WISP
...
; ================
	...
	db 75, NINETALES, LEFTOVERS
		db NASTY_PLOT, SOLAR_FLARE, DARK_PULSE, SHADOW_BALL
	db -1 ; end
