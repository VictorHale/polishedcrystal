	...
	; tm/hm learnset
	tmhm CURSE, TOXIC, HAIL, HIDDEN_POWER, HONE_CLAWS, ICE_BEAM, BLIZZARD, PROTECT, RAIN_DANCE, GIGA_DRAIN, RETURN, DIG, ROCK_SMASH, DOUBLE_TEAM, SANDSTORM, FARORES_WIND, SUBSTITUTE, FACADE, REST, ATTRACT, THIEF, ROCK_SLIDE, LEECH_LIFE, SCALD, JABUS_FROST, SURF, WHIRLPOOL, WATERFALL, BODY_SLAM, DOUBLE_EDGE, EARTH_POWER, ENDURE, ICY_WIND, IRON_HEAD, KNOCK_OFF, ROLLOUT, SLEEP_TALK, SWAGGER
	; end
