...
endc
	...
	; tm/hm learnset
	tmhm DRAGON_CLAW, CURSE, ROAR, TOXIC, HIDDEN_POWER, SUNNY_DAY, HONE_CLAWS, HYPER_BEAM, PROTECT, SAFEGUARD, BULLDOZE, SOLAR_BEAM, GILDED_SLASH, RETURN, DIG, ROCK_SMASH, DOUBLE_TEAM, FLAMETHROWER, SOLAR_FLARE, SWIFT, FARORES_WIND, SUBSTITUTE, FACADE, FLAME_CHARGE, REST, ATTRACT, THIEF, ROCK_SLIDE, WILD_CHARGE, DRAGON_PULSE, WILL_O_WISP, GIGA_IMPACT, STRENGTH, AGILITY, BATON_PASS, BODY_SLAM, DOUBLE_EDGE, ENDURE, HEADBUTT, HYPER_VOICE, IRON_HEAD, KNOCK_OFF, ROLLOUT, SEED_BOMB, SLEEP_TALK, SUCKER_PUNCH, SWAGGER
	; end
