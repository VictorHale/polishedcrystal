...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move SKY_UPPERCUT, EFFECT_JUMP_KICK,          80, FIGHTING,  100, 10,   0, PHYSICAL
	move FARORES_WIND, EFFECT_FARORES_WIND,       60, FLYING,    100, 10,  30, SPECIAL
	move DRAGON_CLAW,  EFFECT_ATTACK_UP_HIT,      70, DRAGON,    100, 10,  50, PHYSICAL
	move SNARL,        EFFECT_ATTACK_DOWN_HIT,    70, DARK,      100, 10, 100, SPECIAL
	...
	move X_SCISSOR,    EFFECT_FLINCH_HIT,         70, BUG,       100, 10,   0, PHYSICAL
	move NIGHT_SLASH,  EFFECT_NORMAL_HIT,         80, DARK,      100, 10,   0, PHYSICAL
	move AIR_SLASH,    EFFECT_FLINCH_HIT,         70, FLYING,    100, 10,  30, SPECIAL
...
endc
	move AERIAL_ACE,   EFFECT_ALWAYS_HIT,         70, FLYING,    100, 10,   0, PHYSICAL
	move WING_ATTACK,  EFFECT_FLINCH_HIT,         70, FLYING,    100, 20,   0, PHYSICAL
...
endc
	move DAZZLINGLEAM, EFFECT_DAZZLINGLEAM,       80, FAIRY,     100, 10,   0, SPECIAL
	move VOLT_SWITCH,  EFFECT_SWITCH_HIT,         80, ELECTRIC,  100, 10,   0, SPECIAL
	...
	move FOCUS_BLAST,  EFFECT_SP_DEF_DOWN_HIT,   100, FIGHTING,  100, 10,  50, SPECIAL
...
endc
	...
	move U_TURN,       EFFECT_SWITCH_HIT,         80, BUG,       100, 10,   0, PHYSICAL
...
endc
	...
	move BLIZZARD,     EFFECT_FREEZE_HIT,        110, ICE,        70, 10,  50, SPECIAL
	...
	move JABUS_FROST,  EFFECT_JABUS_FROST,        80, WATER,     100, 10,  30, SPECIAL
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        150, NORMAL,     90,  5,   0, SPECIAL
	move PECK,         EFFECT_NORMAL_HIT,         35, FLYING,    100, 35,   0, PHYSICAL
	move DRILL_PECK,   EFFECT_FLINCH_HIT,         80, FLYING,    100, 20,   0, PHYSICAL
...
endc
	...
	move HYPNOSIS,     EFFECT_SLEEP,               0, PSYCHIC,    90, 10,   0, STATUS
	...
	move FLASH_CANNON, EFFECT_SP_DEF_DOWN_HIT,    80, STEEL,     100, 10,  30, SPECIAL
if DEF(FAITHFUL)
...
endc
	...
	move GUNK_SHOT,    EFFECT_TOXIC_HIT,         100, POISON,    100, 10,  30, PHYSICAL
	...
	move SOLAR_FLARE,  EFFECT_PSYSTRIKE,         100, FIRE,      100, 10,   0, SPECIAL
	...
	move BULLDOZE,     EFFECT_SPEED_DOWN_HIT,     80, GROUND,    100, 10, 100, PHYSICAL
	...
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,         120, FIGHTING,   95, 10,   0, PHYSICAL
	move GLARE,        EFFECT_PARALYZE,            0, NORMAL,    100, 30,   0, STATUS
	move DREAM_EATER,  EFFECT_DREAM_EATER,       100, PSYCHIC,   100, 10,   0, SPECIAL
	move POISON_JAB,   EFFECT_TOXIC_HIT,          70, POISON,    100, 10,  50, PHYSICAL
	move BULLET_PUNCH, EFFECT_PRIORITY_HIT,       40, STEEL,     100, 30,   0, PHYSICAL
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          80, BUG,       100, 10,   0, SPECIAL
	move DRAIN_KISS,   EFFECT_LEECH_HIT,          70, FAIRY,     100, 10,   0, SPECIAL
	...
	move PLASTIZE,     EFFECT_SACRED_FIRE,        70, ELECTRIC,  100, 10,  50, PHYSICAL
	move SPORE,        EFFECT_SLEEP,               0, GRASS,     100, 15,   0, STATUS
	move FLASH,        EFFECT_ACCURACY_DOWN,       0, NORMAL,    100, 20,   0, STATUS
	move PSYCHO_CUT,   EFFECT_PSYCHO_CUT,         70, PSYCHIC,   100, 10,  30, PHYSICAL
...
if DEF(FAITHFUL)
	...
	move CRABHAMMER,   EFFECT_FLINCH_HIT,        100, WATER,     100, 20,   0, PHYSICAL
endc
...
if DEF(FAITHFUL)
	...
	move FURY_STRIKES, EFFECT_FURY_STRIKES,       20, NORMAL,    100, 10,   0, PHYSICAL
endc
	move BONEMERANG,   EFFECT_DOUBLE_HIT,         50, GROUND,    100, 10,   0, PHYSICAL
	move REST,         EFFECT_HEAL,                0, PSYCHIC,   100, 10,   0, STATUS
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         70, ROCK,      100, 10,  30, PHYSICAL
	...
	move DRAIN_PUNCH,  EFFECT_LEECH_HIT,          80, FIGHTING,  100, 10,   0, PHYSICAL
	...
	move FLAME_CHARGE, EFFECT_SPEED_UP_HIT,       80, FIRE,      100, 10, 100, PHYSICAL
	...
	move ENERGY_BALL,  EFFECT_SP_DEF_DOWN_HIT,    90, GRASS,     100, 10,  30, SPECIAL
	move AEROBLAST,    EFFECT_FARORES_WIND,       95, FLYING,    100,  5,  50, SPECIAL
	move SEED_BOMB,    EFFECT_FLINCH_HIT,         70, GRASS,     100, 10, 100, PHYSICAL
	...
	move SLUDGE_BOMB,  EFFECT_TOXIC_HIT,          80, POISON,    100, 10,  50, SPECIAL
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  60, GROUND,    100, 10, 100, SPECIAL
if DEF(FAITHFUL)
...
endc
	...
	move ICY_WIND,     EFFECT_SPEED_DOWN_HIT,     80, ICE,       100, 10, 100, SPECIAL
	move POWER_GEM,    EFFECT_PSYSTRIKE,          70, ROCK,      100, 10,   0, SPECIAL
	...
	move GIGA_DRAIN,   EFFECT_LEECH_HIT,          80, GRASS,     100, 15,   0, SPECIAL
	...
	move BUG_BUZZ,     EFFECT_SP_DEF_DOWN_HIT,    90, BUG,       100, 10,  30, SPECIAL
...
endc
	move ELDINS_WRATH, EFFECT_ELDINS_WRATH,       70, GROUND,    100, 10, 100, SPECIAL
	...
	move DRAGONBREATH, EFFECT_PARALYZE_HIT,       80, DRAGON,    100, 10,  50, SPECIAL
...
endc
	...
	move GILDED_SLASH, EFFECT_PARALYZE_HIT,       70, STEEL,     100, 10,  30, PHYSICAL
...
endc
	...
	move RAIN_DANCE,   EFFECT_RAIN_DANCE,          0, WATER,     100, 10,   0, STATUS
	move SUNNY_DAY,    EFFECT_SUNNY_DAY,           0, FIRE,      100, 10,   0, STATUS
...
if DEF(FAITHFUL)
	...
	move BRICK_BREAK,  EFFECT_BRICK_BREAK,        80, FIGHTING,  100, 10,   0, PHYSICAL
endc
if DEF(FAITHFUL)
...
endc
	move DARK_PULSE,   EFFECT_FLINCH_HIT,         70, DARK,      100, 10,  30, SPECIAL
	move MOONBLAST,    EFFECT_SP_ATK_DOWN_HIT,   100, FAIRY,     100, 10,  30, SPECIAL
	move PLAY_ROUGH,   EFFECT_ATTACK_DOWN_HIT,    80, FAIRY,     100, 10,  30, PHYSICAL
	move DISARM_VOICE, EFFECT_ALWAYS_HIT,         60, FAIRY,     100, 10,   0, SPECIAL
