...
; entries correspond to *_TMNUM constants (see constants/item_constants.asm)
	...
	db SOLAR_FLARE  ; TM38 (Goldenrod Dept. Store)
	db SWIFT        ; TM39 (Union Cave)
	db FARORES_WIND ; TM40 (Mount Mortar)
	...
	db ELDINS_WRATH ; TM71 (Blue)
	db VOLT_SWITCH  ; TM72 (Route 10)
	db PLASTIZE     ; TM73 (Rock Tunnel)
	...
	db SNARL        ; MT20 (Goldenrod Game Corner)
